...
# Farelogix EK
export WP_CHANNELS_FARELOGIX_EK_HOST=${WP_CHANNELS_FARELOGIX_EK_HOST:-ek.farelogix.com}
export WP_CHANNELS_FARELOGIX_EK_PROXY_PASS=${WP_CHANNELS_FARELOGIX_EK_PROXY_PASS:-${WP_SERVER_PROXY_PASS:-"https://${WP_CHANNELS_FARELOGIX_EK_HOST}"}}
export WP_CHANNELS_FARELOGIX_EK_API_KEY=${WP_CHANNELS_FARELOGIX_EK_API_KEY:-}
export WP_CHANNELS_FARELOGIX_EK_AGENT=${WP_CHANNELS_FARELOGIX_EK_AGENT:-}
export WP_CHANNELS_FARELOGIX_EK_USERNAME=${WP_CHANNELS_FARELOGIX_EK_USERNAME:-}
export WP_CHANNELS_FARELOGIX_EK_PASSWORD=${WP_CHANNELS_FARELOGIX_EK_PASSWORD:-}
